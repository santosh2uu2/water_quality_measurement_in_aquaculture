...
void loop() {
  ...
  if(millis()-printTimepoint > 800U){
    ...
    Serial.println(str_temp_data);
    client.publish("device1/temp", str_temp_data);
    Serial.print("Humidity - ");
   Serial.println(str_hum_data);
    client.publish("device1/hum", str_hum_data);
     Serial.print("ldr - ");
     Serial.println(str_ldr_data);
    client.publish("device1/light", str_ldr_data);
    Serial.print("tds - ");
    Serial.println(str_tds_data);
    client.publish("device1/tds", str_tds_data);
  }
}}}
